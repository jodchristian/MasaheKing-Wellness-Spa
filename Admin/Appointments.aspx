<%@ Page Title="Appointments" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeBehind="Appointments.aspx.cs" Inherits="MasaheKingWellnessSpa.Admin.Appointments" %>
    ...
    <asp:UpdatePanel ID="upMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div id="main" style="display: flex; gap: 20px;">
                ...
                <!-- Left Side: GridView for Appointments -->
                ...
                <asp:Panel ID="pnlDetails" runat="server" Visible="false" CssClass="form" style="flex: 1;">
                    <h3 style="text-align: center; color: #b4830a; font-weight: 700; font-size: 2em;">
                        Appointment #<asp:Label ID="lblTrackingID" runat="server" CssClass="style: color: #b4830a; font-weight: 700; font-size: 2em;"></asp:Label>
                    </h3>
